...
insert into customers values ('RN63-T839Y', '604-960-1292', 'Vivianne', '807 Debra Lane');
insert into customers values ('JT96-M354X', '604-473-6551', 'Abra', '15632 Harper Road');
insert into customers values ('UV31-M204P', '604-537-9772', 'Marget', '45925 Larry Hill');
insert into customers values ('KO76-E138C', '778-069-9266', 'Jorie', '88 Claremont Junction');
insert into customers values ('FV09-Q094J', '604-024-5610', 'Yorgos', '475 Morrow Drive');
insert into customers values ('MF73-P436X', '778-103-3525', 'Brianna', '1 Sunfield Parkway');
insert into customers values ('BS53-F417V', '604-404-8946', 'Biddie', '841 idge Point');
insert into customers values ('PA54-X962R', '604-196-0247', 'Pepe', '47869 Fordem Avenue');
insert into customers values ('XD02-T391D', '604-121-0953', 'Dari', '56304 Service Terrace');
insert into customers values ('CP53-I288A', '604-281-3817', 'Miran', '0 Lerdahl Hill');
insert into customers values ('US32-B170G', '604-742-8883', 'Valentino', '88 Schurz Crossing');
insert into customers values ('HZ91-J502D', '778-466-4023', 'Vera', '60417 Colorado Plaza');
insert into customers values ('CA37-X440B', '604-738-7238', 'Vivien', '61 Eastlawn Way');
insert into customers values ('UB76-M784C', '604-676-2347', 'Clio', '6 Carey Circle');
insert into customers values ('OL07-P265M', '778-562-6633', 'Karolina', '710 Independence Circle');
insert into customers values ('EL97-U110N', '604-114-6909', 'Allix', '4 Monterey Way');
insert into customers values ('ID06-O589S', '778-838-9345', 'Clair', '0 Drewry Lane');
insert into customers values ('XR88-F302P', '604-041-5530', 'Dar', '9 Ronald Regan Trail');
